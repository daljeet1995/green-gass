...
{
	$query = mysqli_query($connection,"INSERT into bookings values('','$uname','$currentDate')");
	$qry_to_update_lastDate = mysqli_query($connection,"update users set lastDate = '$currentDate' where uname = '$uname'");
